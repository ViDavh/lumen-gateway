...
namespace Vidavh\Gateway\Gateways\Mellat;
...
class Mellat extends Port implements PortInterface
{
    /**
    ...
    {
        if (!$this->callbackUrl)
            $this->callbackUrl = $this->config->get('gateway.gateways.mellat.callback-url');
    ...
    protected function sendPayRequest()
    {
        ...
        $fields = array(
            'terminalId' => $this->config->get('gateway.gateways.mellat.terminalId'),
            'userName' => $this->config->get('gateway.gateways.mellat.username'),
            'userPassword' => $this->config->get('gateway.gateways.mellat.password'),
